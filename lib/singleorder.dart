                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      Text("Lacoste", style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold)),
                      SizedBox(
                        height: 10,
                      ),
                      Text("BDT 10,000", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
                      Padding(
                      ...
                      Text("BDT 5,000", style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold)),
              ...
              Row(
                ...
                children: [
                  ...
                  Text("Change", style: TextStyle(
                    color: Color(0xff00C2E4), fontWeight: FontWeight.bold
                  ))
                ],
              ),
              Padding(
                ...
                child: ListView(
                  children: [
                    ListTile(
                      ...
                      title: Text("First payment", style: TextStyle(fontWeight: FontWeight.bold)),
                    ...
                    ListTile(
                      ...
                      title: Text("Second payment", style: TextStyle(fontWeight: FontWeight.bold)),
                      subtitle: Text("Wed, 25 August", style: TextStyle(fontSize: 13)),
                      trailing: Padding(
                        padding: const EdgeInsets.all(7.0),
                        child: Column(
                    ...
                    ListTile(
                      ...
                      title: Text("Third payment", style: TextStyle(fontWeight: FontWeight.bold)),
                      subtitle: Text("Wed, 25 August", style: TextStyle(fontSize: 13)),
                      trailing: Container(
                        child: Padding(
                          padding: const EdgeInsets.all(7.0),
                          child: Text("Pay BDT 2212", style: TextStyle(fontSize: 10, color: Colors.white)),
                        ),
                        decoration: BoxDecoration(
                    ...
                    ListTile(
                      ...
                      title: Text("Final payment", style: TextStyle(fontWeight: FontWeight.bold)),
                      subtitle: Text("Wed, 25 August", style: TextStyle(fontSize: 13)),
                      trailing: Padding(
                        padding: const EdgeInsets.all(7.0),
                        child: Text("BDT 2212", style: TextStyle(fontSize: 10, color: Colors.grey)),
                      ),
                    ),
                  ],
                ),
